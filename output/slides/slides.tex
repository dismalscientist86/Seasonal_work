    ...
    \begin{column}{0.55\textwidth}
      \begin{table}
        ...
        \begin{tabular}{lcc}
          ...
          111160 Rice farming                 & 0.563 & 22 \\
          111199 Other grain farming          & 0.398 & 23 \\
          111219 Other veg.\ (ex. potato) farm.\ & 0.462 & 16 \\
          111998 Other misc.\ crop farming     & 0.328 & 20 \\
          111120 Oilseed (ex.\ soybean) farm.\ & 0.348 & 12 \\
    ...
    \begin{column}{0.42\textwidth}
      \begin{itemize}
        ...
        \item Seasonal index normalized to [0,1] via 99th-pct winsorization ---
              raw amplitude is right-skewed (median 0.03, max 0.96), so
              dividing by the true max would compress everyone else near 0;
              cost is that the top $\sim$10 industries all tie at exactly 1.00
...
\begin{frame}{National Seasonal Index: Sector Summary}
  \begin{table}
    ...
    \begin{tabular}{lcc}
      ...
      \midrule
      Agriculture, forestry, fishing      & 0.504 & 15.7 \\
      Arts, entertainment \& recreation   & 0.461 & 14.3 \\
      Accommodation \& food services      & 0.345 & 10.3 \\
      Educational services                & 0.272 & 8.4  \\
      Construction                        & 0.193 & 5.9  \\
...
\begin{frame}{Geographic Variation: Overview}
  \begin{itemize}
    ...
    \item We compute ExcessPeak for each state $\times$ 6-digit NAICS cell
          (42,344 cells with $\geq 5$ year-observations)
    \bigskip
    \item \textbf{Main finding:} a 2.8$\times$ gap between most and least seasonal
          states in mean peak excess (Alaska: 9.6 p.p.\ vs.\ Texas: 3.4 p.p.)
    ...
    \begin{enumerate}
      \item Agriculture (cross-state SD = 14.5 p.p.)
      \item Arts \& entertainment (SD = 13.4 p.p.)
    ...
    \bigskip
    \item \textbf{Caveat:} per-state QWI coverage years are uneven --- 40 of 51
          states span the full 2000--2023 window, but 11 have partial coverage.
          \textbf{Alaska, the most seasonal state above, only has data through
          2016} (missing 2017--2023); Massachusetts only starts in 2010.
  \end{itemize}
\end{frame}
...
\begin{frame}{Construction and Agriculture by State}
  ...
  (23.5 p.p.), Alaska (23.1 p.p.), Montana, and Idaho.}
\end{frame}
